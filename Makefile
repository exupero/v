...
build/v.core.js: src/macros.sjs src/v.core.js
	cat src/macros.sjs src/v.core.js | node_modules/.bin/sjs -s -o build/v.core.js
...
build/v.min.js: build/v.js lib/*.js
	node_modules/.bin/browserify build/v.js | node_modules/.bin/uglifyjs -c warnings=false -m toplevel -o build/v.min.js
